...
#define CUSTOM_MACHINE_NAME "OdB BQ BLT BF234 UBL  "
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 8000, 208.0 } // Z original = 218.77
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -26, -35, -1.25 }
...
//#define NO_MOTION_BEFORE_HOMING // Inhibit movement until all axes have been homed Retiré BQ
