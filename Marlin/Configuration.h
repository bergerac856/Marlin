 ...
 *
 * VERSION HEPHESTOS 2 BLTouch
 * 
 * Version O.de Broqueville 
 * 
 */
#pragma once
...
#define CUSTOM_MACHINE_NAME "OdB BQ BLT BF240 BLin  "

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "8d083632-40c5-4649-85b8-43d9ae6c5d55" // BQ Hephestos 2 standard config 06d38955-9fcd-46f4-8dd2-dedc58912aa7 (OdB)
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    // Tuned PID values using M303 // Hephestos 2 OdB
    #define DEFAULT_Kp  38.17
    #define DEFAULT_Ki   3.43
    #define DEFAULT_Kd  106.32
...
#define Z_MIN_ENDSTOP_INVERTING true  // Set to true to invert the logic of the endstop. // pour BLTOUCH
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 8065, 208.0 } // E original = 218.77 / Z original = 8000
 ...
 */
//#define FIX_MOUNTED_PROBE // (Retirer pour BLTOUCH)
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -26, -35, -1.70 } // -1.8
